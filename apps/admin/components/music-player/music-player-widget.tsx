...
export function MusicPlayerWidget() {
	...
	if (isMinimized) {
		return (
			<div className="fixed bottom-4 right-4 z-50 flex items-center gap-2 rounded-full bg-background border shadow-lg px-3 py-2">
	...
	return (
		<div className="fixed bottom-4 right-4 z-50 w-80 rounded-xl bg-background border shadow-xl overflow-hidden">
			{/* Header */}
