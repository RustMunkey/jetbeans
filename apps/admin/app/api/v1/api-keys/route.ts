...
import { adminApiKeys, users } from "@jetbeans/db/schema"
import {
...
import { DEFAULT_API_KEY_PERMISSIONS } from "@jetbeans/db/schema"
...
async function getWorkspaceFromSession() {
	...
	const { userWorkspacePreferences, workspaceMembers, workspaces } = await import("@jetbeans/db/schema")
