...
export async function POST(request: Request) {
	...
	try {
		...
		const baseUrl = process.env.NEXT_PUBLIC_ADMIN_URL || "https://app.jetbeans.cafe"
...
\`\`\`bash
npm install @jetbeans/storefront-client
\`\`\`

4. Initialize the client in your app:
\`\`\`typescript
import { StorefrontClient } from '@jetbeans/storefront-client'
