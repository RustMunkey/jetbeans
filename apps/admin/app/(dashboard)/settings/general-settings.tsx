...
export function GeneralSettings({ settings }: { settings: Setting[] }) {
	...
	// Email
	const [emailFromName, setEmailFromName] = useState(getVal(settings, "email_from_name") || "JetBeans")
				...
				<CardContent className="space-y-4">
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
						<div className="space-y-2">
							...
							<Input value={metaTitle} onChange={(e) => setMetaTitle(e.target.value)} placeholder="JetBeans - Premium Coffee" />
						</div>
						<div className="space-y-2">
				...
				<CardContent className="space-y-4">
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
						<div className="space-y-2">
							...
							<Input value={emailFromName} onChange={(e) => setEmailFromName(e.target.value)} placeholder="JetBeans" />
						</div>
						<div className="space-y-2">
							<Label>From Email</Label>
							<Input type="email" value={emailFrom} onChange={(e) => setEmailFrom(e.target.value)} placeholder="noreply@jetbeans.app" />
						</div>
						<div className="space-y-2">
							<Label>Reply-To</Label>
							<Input type="email" value={emailReplyTo} onChange={(e) => setEmailReplyTo(e.target.value)} placeholder="support@jetbeans.app" />
						</div>
						<div className="space-y-2">
							<Label>BCC on Orders</Label>
							<Input type="email" value={emailBcc} onChange={(e) => setEmailBcc(e.target.value)} placeholder="orders@jetbeans.app" />
						</div>
					</div>
				</CardContent>
			</Card>
				...
				<CardContent className="space-y-4">
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
						<div className="space-y-2">
							...
							<Input value={storefrontUrl} onChange={(e) => setStorefrontUrl(e.target.value)} placeholder="https://jetbeans.app" />
						</div>
						<div className="space-y-2">
						...
						<div className="space-y-2">
							<Label>API URL</Label>
							<Input value={apiUrl} onChange={(e) => setApiUrl(e.target.value)} placeholder="https://api.jetbeans.app" />
						</div>
						<div className="space-y-2">
							<Label>CDN URL</Label>
							<Input value={cdnUrl} onChange={(e) => setCdnUrl(e.target.value)} placeholder="https://cdn.jetbeans.app" />
						</div>
					</div>
				</CardContent>
			</Card>
