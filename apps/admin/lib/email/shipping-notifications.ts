...
Thanks for shopping with JetBeans!
...
- The JetBeans Team`,
			html: `
				<div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
					...
					<p style="font-size: 16px; color: #333; line-height: 1.6;">Thanks for shopping with JetBeans!</p>

					<p style="font-size: 14px; color: #666; margin-top: 32px;">
						- The JetBeans Team<br>
						<a href="https://jetbeans.cafe" style="color: #2563eb;">jetbeans.cafe</a>
					</p>
				</div>
			`,
		},
			...
			html: `
				<div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
					...
					<p style="font-size: 16px; color: #333; line-height: 1.6;">
						...
						<a href="mailto:support@jetbeans.cafe" style="color: #2563eb;">reach out to us</a>.
					</p>
