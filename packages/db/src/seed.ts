...
async function seed() {
	...
	const productData = [
		...
		{ name: "House Blend Classic", slug: "house-blend-classic", description: "Our signature house blend — reliable, comforting, and always consistent.", price: "14.99", categoryId: catBlends.id, tags: ["blend", "light-roast", "classic"], isActive: true, metaTitle: "House Blend Classic — Our Signature Coffee | JetBeans", metaDescription: "Our signature house blend — reliable, comforting, and always consistent. The perfect everyday coffee." },
		{ name: "Ethiopian Yirgacheffe", slug: "ethiopian-yirgacheffe", description: "Bright and fruity with notes of blueberry, jasmine, and citrus. A light roast from the birthplace of coffee.", price: "21.99", categoryId: catSingleOrigin.id, tags: ["single-origin", "light-roast", "ethiopia"], isActive: true, isFeatured: true, metaTitle: "Ethiopian Yirgacheffe — Single Origin Light Roast | JetBeans", metaDescription: "Bright and fruity Ethiopian coffee with notes of blueberry, jasmine, and citrus. From the birthplace of coffee." },
		...
		{ name: "JetBeans Travel Mug", slug: "jetbeans-travel-mug", description: "Double-walled stainless steel travel mug. Keeps coffee hot for 6 hours.", price: "24.99", categoryId: catAccessories.id, tags: ["accessories", "merch"], isActive: true },
	]
	...
	const mugProduct = products.find(p => p.slug === "jetbeans-travel-mug")!
	variantData.push(
	...
	await db.insert(schema.blogPosts).values([
		{
			...
			metaTitle: "The Ultimate Guide to Pour-Over Coffee | JetBeans",
		...
		},
		{
			...
			content: "<h2>Why Direct Trade Matters</h2><p>When we started JetBeans, we knew we wanted to do things differently. Direct trade means working face-to-face with farmers, paying fair prices, and ensuring sustainable practices from seed to cup.</p><p>This post has been archived as we update our sourcing story.</p>",
	...
	await db.insert(schema.sitePages).values([
		...
		},
		{
			...
			status: "published",
			metaTitle: "FAQ | JetBeans",
		},
		{
			title: "Contact",
			slug: "contact",
			content: "<h2>Get in Touch</h2><p>Have a question or just want to say hi? We'd love to hear from you.</p><p><strong>Email:</strong> hello@jetbeans.cafe</p><p><strong>Hours:</strong> Monday - Friday, 9am - 5pm EST</p><p>We typically respond within 24 hours.</p>",
			status: "published",
		},
	])
	...
	await db.insert(schema.siteContent).values([
		...
		{ key: "footer_tagline", type: "text", value: "Fuel your day with JetBeans" },
		{ key: "footer_copyright", type: "text", value: "© 2025 JetBeans. All rights reserved." },
	...
	await db.insert(schema.emailTemplates).values([
		{
			...
			subject: "Your JetBeans order #{{order_number}} is confirmed!",
			body: "<h2>Thank you for your order!</h2><p>Hi {{customer_name}},</p><p>We've received your order and are getting it ready. Here's a summary:</p><p><strong>Order #{{order_number}}</strong></p><p>Total: {{order_total}}</p><p>We'll send you a shipping notification once your order is on its way.</p><p>Cheers,<br/>The JetBeans Team</p>",
		...
		},
		{
			...
			subject: "Your JetBeans order is on its way!",
		...
		},
		{
			...
			subject: "Your JetBeans subscription is active!",
		...
		},
		{
			name: "Payment Failed",
			slug: "payment_failed",
			subject: "Action needed: Payment failed for your JetBeans order",
		...
		},
		{
			name: "Password Reset",
			slug: "password_reset",
			subject: "Reset your JetBeans password",
		...
		},
		{
			...
			subject: "Verify your JetBeans email",
		...
		},
		{
			name: "Team Invite",
			slug: "team-invite",
			subject: "You've been invited to JetBeans Admin",
			body: "<h2>You're invited!</h2><p>{{inviter_name}} has invited you to join the JetBeans admin panel as <strong>{{role}}</strong>.</p><p>Sign in with your Google account ({{invitee_email}}) to get started:</p><p><a href='{{login_url}}'>Sign In to JetBeans Admin</a></p><p>This invite will expire in 7 days.</p>",
	...
	await db.insert(schema.storeSettings).values([
		{ key: "store_name", value: "JetBeans", group: "general" },
		{ key: "store_tagline", value: "Premium coffee, delivered.", group: "general" },
		{ key: "contact_email", value: "hello@jetbeans.cafe", group: "general" },
