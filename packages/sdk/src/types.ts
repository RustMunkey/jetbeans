...
export interface JetBeansConfig {
  /** Storefront API key (starts with sf_) */
  apiKey: string
  /** Base URL of the JetBeans API (defaults to https://app.jetbeans.cafe) */
  baseUrl?: string
...
export class JetBeansError extends Error {
  constructor(
    message: string,
