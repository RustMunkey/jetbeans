# JetBeans SaaS Platform

## Vision

Monetize JetBeans as a subscription SaaS platform. Other entrepreneurs pay to rent the infrastructure and start their own ecommerce brands using our system.

**Two Business Models:**
1. **JetBeans Brand** - Our own store (skate gear, coffee, matcha, tea, apparel)
2. **JetBeans Platform** - Others pay to run their stores on our infrastructure
...
│  ┌─────────────────────────────────────────────────────────────┐    │
│  │                     SUPER ADMIN                              │    │
│  │  (JetBeans team - manages all tenants)                       │    │
│  │                                                              │    │
│  │  • Tenant management                                         │    │
│  │  • Platform billing                                          │    │
│  │  • Usage monitoring                                          │    │
...
- Custom domain: $10/mo
- White-label (remove JetBeans branding): $50/mo
...
- [ ] `/super-admin` route (JetBeans team only)
- [ ] List all tenants
...
| **JetBeans** | $29-199/mo | Modern stack, automation-first |
...
*This is the long-term vision. First priority is getting JetBeans (our own brand) working perfectly with the automation pipeline. SaaS expansion comes after.*
